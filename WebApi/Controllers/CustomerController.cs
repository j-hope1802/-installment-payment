...
{
    private readonly CustomerService _todoService;
    private readonly IWebHostEnvironment _environment;

    public CustomerController(CustomerService todoService, IWebHostEnvironment environment)
    {
    ...
    public async Task<Response<CustomerDto>> AddCustomer([FromBody] AddCustomer customer)
    {
